...
Ollama Downloader in Rust (ODIR), pronounced _oh dear_, is a command-line tool written in Rust for downloading models from Ollama. The project has been inspired by the original Python implementation called [Ollama Downloader](https://github.com/anirbanbasu/ollama-downloader), but has been rewritten in Rust to leverage its performance and safety features.
